      ...
      <main className={styles.container}>
        <div className={styles.topContent}>
          ...
          <p className={styles.description}>
            ...
            help—reach out for product inquiries, technical assistance, or any
            other support!
          </p>
          <div className={styles.addressBlock}>
            <strong>Address:</strong>
            <div>
              #23B, GKVK Layout, Sri Rama Arcade Rd, Jakkur, Bangalore-560064,
              Karnataka, India
            </div>
            <div>
            ...
            <div>
              <strong>Phone:</strong> +91-9901820757
            </div>
            <div>
              <strong>GSTIN:</strong> 29DOJPB8311H1ZX
            </div>
          </div>
        </div>
