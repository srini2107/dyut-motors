      ...
      <main className={styles.container}>
        <section className={styles.contentSection}>
          ...
          <p className={styles.paragraph}>
            ...
            with a Dyut motors propeller.
          </p>
          <p className={styles.paragraph}>
            Only the best composite materials are chosen by Dyut Motors to be used in
            ...
            designed. Comprehensive answers for the future world.
          </p>
          <p className={styles.paragraph}>
            With over years of experience in the design, manufacturing, and testing of hobby
            ...
            performing propellers in the market. Our mission is simple - “propulsion”!
          </p>
        </section>
        <section className={styles.gallerySection}>
          <h2 className={styles.galleryTitle}>Gallery</h2>
          <div className={styles.imageGallery}>
            <img src="/123.jpeg" alt="About Dyut Motors" className={styles.image} />
            <img src="/prope1.jpg" alt="Propeller 1" className={styles.image} />
            <img src="/prop2.jpg" alt="Propeller 2" className={styles.image} />
            <img src="/prop3.jpg" alt="Propeller 3" className={styles.image} />
          </div>
        </section>
      </main>
    </div>
